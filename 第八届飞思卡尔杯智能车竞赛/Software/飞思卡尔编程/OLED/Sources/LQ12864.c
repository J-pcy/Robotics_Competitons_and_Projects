...
#define LCD_SCL PORTA_PA5    //D0
#define LCD_SDA	PORTA_PA4    //D1
#define LCD_RST PORTA_PA3    //RST
#define LCD_DC  PORTA_PA2    //DC
...
//返回：无
//==============================================================  
void LCD_P8x16Str(byte x,byte y,byte ch[])//先写上一半再写下一半  y 0~4 x 
{
  byte c=0,i=0,j=0;
