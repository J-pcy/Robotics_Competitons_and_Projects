...
unsigned char black_error=62;   //0-47
...
{
  if(black<=black_Limit&&black>black_Limit-20)
  {
    Car_speed_set=3;
    black_error=62;
    g_fDirectionControlOut=DIR_CONTROL_P*(black_Limit-black); 
  } 
  else if(black<=black_Limit-20)
  {
    Car_speed_set=0;
    black_error=47;
    g_fDirectionControlOut=DIR_CONTROL_P*(black_Limit-black); 
  }
  else if(black>=black_Limit&&black<black_Limit+20)
  {
    Car_speed_set=3;
    black_error=62;
    g_fDirectionControlOut=DIR_CONTROL_P*(black_Limit-black); 
