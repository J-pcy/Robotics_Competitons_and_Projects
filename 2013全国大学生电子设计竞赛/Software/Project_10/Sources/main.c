...
static float Angle_Control_P=4;         //20           /3             /9
	  ...
	  while(PORTB_PB2!=0)
	  {
       ...
       while(running_flag==2) 
       {
			 ...
			 else if(flip_flag==1) 
			 {
			  ...
			  {  
			   if(g==0)  Moto(0,85);
			   if(g>0&&g<20)Dly_ms(20);
			   if(g==20) Moto(0,0);
			   if(g>20&&g<25) Dly_ms(20);
			   if(g==25)Moto(1,85);
			   if(g>27&&g<=45) Dly_ms(20);
			   if(g==46)Moto(0,0);
			   if(g>46&&g<=49) Dly_ms(20);
			   g++;
			   if(g>50) g=0;
			  }
			 } */
...
interrupt VectorNumber_Vpit0 void  timer_inte0(void) 
{
  ...
  if(key2_flag==1)
  {
    ...
    if(Angle_G<100&&Angle_G>-100)
    {
     if(Angle_Z<15&&Angle_Z>-15) key3_flag=1;
    }   
  ...
  if(running_flag==2)
  {
     ...
     {
       /*if(degree_now>95&&degree_now<170)
       {
         dir=1;
         degree_max=degree_now;
       }
       else if(degree_now<-95&&degree_now>-170) 
       {
         dir=0;
         degree_max=-degree_now;
       }
       ...
       if(degree_now<15&&degree_now>-15) running_flag=1;
   
     }                                       
     /*else if((speed_now<200&&speed_now>100)||(speed_now>-200&&speed_now<-100)) 
     {
