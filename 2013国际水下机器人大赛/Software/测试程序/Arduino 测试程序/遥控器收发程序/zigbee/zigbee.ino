...
void loop()
{
   ...
   LCD_write_english_string(42,0,"CH3:");     //如果小于120cm
   LCD_write_english_string(42,1,"CH4:");     //如果小于120cm
...
//   LCD_write_english_string(0,5,"    2012.11   "); 
   ...
   while(1)
   {
     V_CH1=-(analogRead(CH1)-512)/7;
     V_CH2=(analogRead(CH2)-512)/7;
    ...
    LCD_print_number(65, 0,V_CH3);
    LCD_print_number(65, 1,V_CH4);
    LCD_print_number(30, 3,V_BAT);
    Serial.print(V_CH1+135);
    Serial.print('C');
    Serial.print(V_CH3+80);
    Serial.print('L');
    Serial.print(V_CH4+80);
    Serial.print('R');
    Serial.print(digitalRead(RUN));
    Serial.print('U');
    if(Serial.available())
	{
