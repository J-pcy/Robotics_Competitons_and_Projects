...
float CH2_middle = 555;
float CH3_middle = 513;
float CH4_middle = 541;
...
//   LCD_write_english_string(0,4,"CH5:");
...
//   LCD_write_english_string(42,4,"Y:");
   ...
   while(1)
   {
     V_CH1=(CH1_MIN-analogRead(CH1))*R_CH1;
     ...
     {
       V_CH3=(CH3_middle-analogRead(CH3))*R1_CH3;
       if(V_CH3<=-255)V_CH3=-255;
     }
     else
     {
       V_CH3=(CH3_middle-analogRead(CH3))*R2_CH3;
       if(V_CH3>=255)V_CH3=255;
     }
