...
float C_Z = 32120;           //目前调速  318-慢
float C_Gyro_y =28500;
float Z_Min = 13753; 
float Z_Max = 44471;
float T_Z = 2;
...
{
  if((Line_Center[59]<=black_Limit+20)&&(Line_Center[59]>black_Limit-20))
  {
    g_fDirectionControlOut=1.1*DIR_CONTROL_P*(black_Limit-Line_Center[59]); 
  } 
  else if((Line_Center[59]<=black_Limit-20)||(Line_Center[59]>=black_Limit+20))
  {
    g_fDirectionControlOut=0.9*DIR_CONTROL_P*(black_Limit-Line_Center[59]); 
  }
}
