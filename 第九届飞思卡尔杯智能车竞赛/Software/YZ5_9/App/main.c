...
void PWM_init()
{
  FTM_PWM_init(FTM0, FTM_CH5,20*1000,0);    //初始化 FTM PWM ，使用 FTM0_CH5，频率为20k ，占空比为 30 / FTM0_PRECISON
  FTM_PWM_init(FTM0, FTM_CH7,20*1000,0);    //初始化 FTM PWM ，使用 FTM0_CH7，频率为20k ，占空比为 30 / FTM0_PRECISON
}
