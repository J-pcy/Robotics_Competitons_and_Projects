...
/*void LCD_Show_Number (unsigned char X,unsigned char Y,int i)
{        
   LCD_set_XY(X,Y); 
   LCD_write_char( 0x30+i/10000);
   LCD_set_XY(X+6, Y);
   LCD_write_char( 0x30+i%10000/1000);
   LCD_set_XY(X+12, Y);
   LCD_write_char( 0x30+i%1000/100);
   LCD_set_XY(X+18, Y);
   LCD_write_char( 0x30+i%100/10);
   LCD_set_XY(X+24, Y);
   LCD_write_char( 0x30+i%10);
}
*/
void LCD_Show_Number (unsigned char X,unsigned char Y,unsigned int number) 
{  
  unsigned char wan,qian,bai,shi,ge;
  wan=number/10000+0x30;
  qian=number%10000/1000+0x30;
  bai=number%1000/100+0x30;
  shi=number%100/10+0x30;
  ge=number%10+0x30;
  LCD_set_XY(X,Y);  
  LCD_write_char2(X,Y,wan);
  LCD_write_char2(X+6,Y,qian);
  LCD_write_char2(X+12,Y,bai);
  LCD_write_char2(X+18,Y,shi);
  LCD_write_char2(X+24,Y,ge);
}
